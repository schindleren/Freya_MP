...
void mainDialog::signIn()
{
    ...
    m_xmppClient.configuration().setHost("jesschindl.vicp.net");
    m_xmppClient.configuration().setPort(54056);
    m_xmppClient.configuration().setDomain("openfire");
    m_xmppClient.configuration().setResource("GuiClient");
...
//    m_xmppClient.setClientPresence(QXmppPresence());
    m_xmppClient.connectToServer(m_xmppClient.configuration(), pres);
}
