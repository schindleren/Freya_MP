...
CONFIG(debug, debug|release) {
    FREYALAUNCHTESTA_NAME = FreyaLaunchTestA_d
} else {
    FREYALAUNCHTESTA_NAME = FreyaLaunchTestA
}

TARGET = $$FREYALAUNCHTESTA_NAME
TEMPLATE = lib
...
DEFINES += FREYALAUNCHTESTA_LIBRARY
...
SOURCES += \
        freyalaunchtesta.cpp

HEADERS += \
        freyalaunchtesta.h \
        freyalaunchtesta_global.h 
